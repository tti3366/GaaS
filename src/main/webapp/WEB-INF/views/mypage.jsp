            ...
            <div class="card-body pt-3">
              ...
              <div class="tab-content pt-2">
                ...
                <div class="tab-pane fade profile-edit pt-3" id="profile-edit">
                  <!-- Profile Edit Form -->
                  <form:form class="row g-3 needs-validation" modelAttribute="updateUserData" action="/updateUserProc" method="post">
<!--                
					<div class="row mb-3">
 ...
 -->
                    ...
                    <div class="row mb-3">
                      ...
                      <div class="col-md-8 col-lg-9">
                        <input name="userPhoneNumber" type="text" class="form-control" id="userPhoneNumber" value="${userInfo.userPhoneNumber}" required>
                    ...
                    <div class="row mb-3">
                      ...
                      <div class="col-md-8 col-lg-9">
                        ...
                        pattern="[a-zA-Z0-9]+[@][a-zA-Z0-9]+[.]+[a-zA-Z]+[.]*[a-zA-Z]*[.]*[a-zA-Z]*" size="40" value="${userInfo.userEmail}" required>
                    ...
                    <div class="row mb-3">
                      ...
                      <div class="col-md-8 col-lg-9">
                        <input name="about" type="text" class="form-control" id="about" value="${userInfo.about}">
                      </div>
                    </div>
                ...
                <div class="tab-pane fade pt-3" id="profile-change-password">
                  <form:form class="row g-3 needs-validation" modelAttribute="changePw" action="/changePwProc" method="post">

                    <div class="row mb-3">
                      <label for="currentPassword" class="col-md-4 col-lg-3 col-form-label">Current Password</label>
                      <div class="col-md-8 col-lg-9">
                        <input name="currentPwd" type="password" class="form-control" id="currentPwd">
                      </div>
                    </div>
                    ...
                    <div class="row mb-3">
                      ...
                      <div class="col-md-8 col-lg-9">
                        <input name="newPwdCheck" type="password" class="form-control" id="newPwdCheck">
                      </div>
                    </div>
                    <div class="text-center">
